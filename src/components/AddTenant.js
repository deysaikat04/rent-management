...
class AddTenant extends Component {
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    let toDate = moment()
      .add(this.state.form.tenure, "months")
      .format("DD-MM-YYYY")
      .toString();
    let fromDate = moment(this.state.form.fromDate)
      .format("DD-MM-YYYY")
      .toString();
    this.setState(
      {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} md={6} lg={6}>
            <TextField
              ...
              {...(formError.fromDate && {
                error: true,
                helperText: `Please select today's date or future date`,
              })}
            />
          </Grid>
          <Grid item xs={6} md={6} lg={6}>
            <TextField
              ...
              {...(formError.tenure && {
                error: true,
                helperText: `Please enter value more than 1 and less than 121`,
              })}
            />
          </Grid>
          <Grid item xs={6} md={6} lg={6}>
