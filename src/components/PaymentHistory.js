...
export default function PaymentHistory(props) {
    ...
    const { payment, handleSelectedPayment } = props;
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = payment ? payment.map((n) => n.name) : '';
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, (payment ? payment.length : 0) - page * rowsPerPage);
            ...
            <Paper className={classes.paper}>
                ...
                <TableContainer>
                    ...
                    >
                        ...
                        />
                        <TableBody>
                            {payment && stableSort(payment, getComparator(order, orderBy))
                ...
                <TablePagination
                    ...
                    component="div"
                    count={payment ? payment.length : 1}
